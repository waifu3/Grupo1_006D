...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-11-2024 a las 17:04:02
...
(1, 'Curso de PHP', '\"Domina PHP, uno de los lenguajes más populares para el desarrollo de aplicaciones web dinámicas.\"', '\"El Curso de PHP está diseñado para introducirte en el desarrollo web del lado del servidor utilizando PHP, un lenguaje ampliamente utilizado en la creación de sitios y aplicaciones dinámicas. Comenzarás con los conceptos básicos, como la sintaxis, variables y estructuras de control. A medida que avances, aprenderás a manejar formularios, sesiones y bases de datos para construir aplicaciones web completas. También exploraremos temas como la seguridad en PHP, la integración con bases de datos MySQL y el uso de patrones de diseño para proyectos organizados. Al finalizar el curso, estarás preparado para desarrollar aplicaciones dinámicas y escalables, así como para integrarte con tecnologías frontend y backend modernas.\"', '2024-10-24 01:39:46', 'PHP', 12, 'prueba', 'prueba 1.1', 'prueba 1.2', 'prueba 1.3', 'cognitiva'),
...
(3, 'Curso de HTML ', '\"Aprende HTML desde cero y construye la estructura de tus propias páginas web.\"', '\"El Curso de HTML está diseñado para principiantes que desean iniciar en el desarrollo web, proporcionando una base sólida en la creación de páginas web estructuradas. Aprenderás a utilizar etiquetas HTML para organizar contenido, crear enlaces, tablas, listas y formularios. Exploraremos las mejores prácticas para escribir un código HTML limpio y semántico, optimizando así la accesibilidad y la experiencia de usuario. Al finalizar, tendrás las habilidades necesarias para construir la estructura de sitios web funcionales y listos para ser estilizados con CSS y complementados con JavaScript.\"', '2024-10-24 01:39:46', 'HTML ', 12, NULL, NULL, NULL, NULL, NULL),
...
(11, 1, 'Introducción', 'uploads/Comunicación básica en Lengua de Señas (LESCO) - Hands-On LESCO (720p, h264, youtube).mp4', '2024-11-04 16:58:31', 'video'),
...
(22, 3, 'CURSO HTML 1 ', './uploads/CURSO_HTML_1_Sordos_y_ceguera__1_.mp4', '2024-11-17 05:24:27', 'video');
...
INSERT INTO `usuarios` (`id`, `username`, `password`, `role_id`, `email`, `full_name`, `telefono`, `direccion`, `reset_token`, `reset_token_expiry`) VALUES
(3, 'Matias', 'ee26b0dd4af7e749aa1a8ee3c10ae9923f618980772e473f8819a5d4940e0db27ac185f8a0e1d5f84f88bc887fd67b143732c304cc5fa9ad8e6f57f50028a8ff', 3, 'profe_test@example.com', 'Test', NULL, NULL, 'b090f11d19ca3869634d555fa9d10b803eff760973220d44e27be3972daf5770', '2024-11-17 04:10:08'),
(5, 'yuko', '$2y$10$8VnLfYLeOq5HOk7u22Qqpu6wpSTsQb29lMXlnUVb5vLsX55STGWGC', 2, 'user_yuko@example.com', NULL, NULL, NULL, NULL, NULL),
(6, 'baby', '$2y$10$1YjsojQzKk13agNKazTOAuy1EdlTNC7uIzU4ppkiH6KKpxktBGHN.', 1, 'admin_baby@example.com', NULL, NULL, NULL, NULL, NULL),
(7, 'prueba', '$2y$10$R3dqz3A6uO8T6Psf5sR.X.GVNKgmxLkgBalhFNXrI0TIfI1PgSu0a', 3, 'profe_prueba@example.com', 'Prueba', NULL, NULL, NULL, NULL),
(8, 'koda', '$2y$10$3AtIanvkbbdLOug/5T5rzORaw886WlDEQcYlY4rjHuw3zy7HpEqAy', 3, 'profe_koda@example.com', 'Koda', NULL, NULL, NULL, NULL),
(9, 'luna', '$2y$10$o9VPp8C3c8PSc5jFbLO/FOa0MCxFxOZ6FjEzZPscI2HW3CL081RWS', 2, 'user1_luna@example.com', 'Luna Cabrera', '0962016509', 'villa maipu', NULL, NULL),
(10, 'Diego', '$2y$10$UfI4XovpG7mxmCMcn/M.cOIKsyqx1YVrZZm/u987BX1WHtiFzoYla', 2, 'user_tuto@example.com', NULL, NULL, NULL, NULL, NULL),
(11, 'Alejandro', '$2y$10$JkS/ce6zYFLGH.QATbptC.q00Kckg14T30aYz6u3HBsm4AWTl/7pO', 2, 'user_matias@example.com', NULL, NULL, NULL, NULL, NULL),
(12, 'amanda', '$2y$10$ztNjDYgkP0evyaKutu5mT.eh6tCw9E8Bg2QDLOsm.SG2XeZ951GgC', 3, 'profe_amanda@example.com', 'Amanda Cabrera', '+56 9 4004 1903', '', NULL, NULL),
(13, 'maria', '$2y$10$w8RDp16DNQExuE3DTcPU5e0DVvJxV1L.aVg4uXBaMj9jY/hJ.Ca8q', 2, 'user_maria@example.com', NULL, NULL, NULL, NULL, NULL),
(14, 'monserrat', '$2y$10$FmtP2w1E5YQMt/Dz.UDRbegSuLOyfBwtodDqNZmWJX25uYuNXvsye', 1, 'admin_monserrat@example.com', NULL, '965025403', 'Villa valparaiso, La Calera', NULL, NULL),
(17, 'Bruno', '$2y$10$4GXFatZsj.mjcYxAlCJyYul6c5GGF4avFsEgMeG3g4V98kYPu/lEu', 2, 'user_bruno@example.com', NULL, NULL, NULL, NULL, NULL),
(18, 'Estefany', '$2y$10$znqDHu9tJr6gl3faE6SaGepjuillxxmYbzsl9yBEmQ5sEsWY9eCga', 2, 'user_estefany1@example.com', NULL, NULL, NULL, NULL, NULL),
(19, 'mariela', '$2y$10$udAqsBWpdftXYJgvtpOTLuQaYnJVAA.Tj6aBYx4nSgCibcnDMAlku', 2, 'user_mariela@example.com', NULL, NULL, NULL, NULL, NULL),
(20, 'juan', '$2y$10$8YsZL10lz/hNO/uzUe8wL.zlS8smSdYXYbRj3V8Q5oUrO9LR7oMG6', 2, 'user_juan@example.com', NULL, NULL, NULL, NULL, NULL),
(24, 'prueba 06', '$2y$10$tAeZ8Due/6hQssbzYLpo.e0qdD3P7pNNKlM5LC6QxFbkztvlvRXdi', 3, 'profe_prueba06@gmail.com', NULL, NULL, NULL, NULL, NULL),
(25, 'rafa', '$2y$10$KGQmap2pAFpSuENN8Uw02.1cThYM3P9EeqyuH4vg64IIQmuZ4Rjt2', 2, 'user_rafa@example.com', NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `certificates`
  ADD CONSTRAINT `certificates_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `certificates_ibfk_2` FOREIGN KEY (`course_id`) REFERENCES `cursos` (`id`) ON DELETE CASCADE;
